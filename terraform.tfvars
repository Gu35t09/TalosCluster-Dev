...
worker_ram = 4096 # Worker VM ram (in MB)
...
control_planes_ip = ["192.168.99.201"]
worker_ip = ["192.168.99.204"]
vip = "192.168.99.200" # https://www.talos.dev/v1.9/talos-guides/network/vip/
cluster_endpoint = "https://192.168.99.200:6443" # This needes to be the same as the Talos "vip" for redundancy
